...
<div class="w3-bar w3-teal">
    ...
    <!-- New Item -->
    %if loc == "new"
    <a href="/new_item" class="w3-button w3-bar-item w3-teal w3-hover-purple selected">New Item</a>
    %else:
    ...
    <!-- Right Side | Ajax -->
    %if not old:
    <a href="/" class="w3-button w3-right w3-bar-item w3-teal w3-hover-purple selected">Ajax List</a>
    ...
    <a href="/old" class="w3-button w3-right w3-bar-item w3-teal w3-hover-purple selected">Old List</a>
    %end
</div>
%end